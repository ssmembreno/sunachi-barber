...
class CalendarAdminRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'services.array' => 'Los servicios deben estar en formato de lista.',
            'services.*.service_id.required' => 'Cada servicio debe tener un identificador.',
            'services.*.service_id.exists' => 'El servicio seleccionado no es válido.',
            'services.*.price.required' => 'Cada servicio debe tener un precio.',
            'services.*.price.numeric' => 'El precio de al menos un servicio no es un número válido.',
